...
                # 2. Renombra la columna de flag a un nombre final y el de Hrs/Min a un nombre más claro
...
                df_resultado['Estado_Llegada'] = df_resultado['Llegada_Tarde_Flag'].map({True: 'Tarde', False: 'A tiempo'})
                ...
                # 4. Define las columnas a mostrar en Streamlit (excluyendo el flag auxiliar booleano)
                columnas_mostrar = [
...
                    # Selecciona las columnas para exportar (igual que las de la vista)
